    ...
    <div className="space-y-8">
      ...
      <div className="bg-[#0a0a0a] border border-white/5 rounded-xl p-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-light text-white">{user?.user_metadata?.full_name || 'Customer'}</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#0a0a0a] border border-white/5 rounded-xl p-6">
          <h3 className="text-white/40 text-sm font-light mb-2">Total Orders</h3>
          <p className="text-3xl font-light text-white">{orders?.length || 0}</p>
        </div>
        <div className="bg-[#0a0a0a] border border-white/5 rounded-xl p-6">
