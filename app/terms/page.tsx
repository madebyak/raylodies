...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for using Raylodies and purchasing digital products.",
};
    ...
    >
      ...
      >
        ...
        <p>
          ...
          jurisdiction to use the Service. If you use the Service on behalf of
          an organisation, you confirm you have authority to bind that
          organisation.
        </p>
        <h3>1.2 Right to Refuse Service</h3>
        <p>
          To the extent permitted by law, we may refuse service, restrict
          access, or cancel orders in cases of suspected fraud, misuse, policy
          violations, or abuse.
        </p>
        <h3>1.3 Changes</h3>
        <p>
          We may update products, pricing, and site content at any time.
          Continued use of the Service means you accept any posted updates.
        </p>

        <h2 id="payments">2. Merchant of Record &amp; Payments</h2>
        <h3>2.1 Merchant of Record</h3>
        <p>
          Checkout is handled by Paddle.com (“Paddle”), which acts as the
          Merchant of Record for purchases made through this website. Paddle
          processes payments and handles applicable tax collection where
          required.
        </p>
        <h3>2.2 Paddle Terms</h3>
        <p>
          By purchasing, you acknowledge you are purchasing from Paddle and
          agree to Paddle’s applicable buyer terms and policies, in addition to
          these Terms.
        </p>
        <h3>2.3 Billing Support</h3>
        <p>
          Payment, invoice, tax, and charge dispute support may be handled by
          Paddle. For product usage or access issues, contact{" "}
        ...
        <p>
          Our products are digital goods (e.g., prompts, digital prints,
          mockups, blueprints, templates, and similar downloadable assets)
          unless explicitly stated otherwise.
        </p>
        <h3>3.2 Delivery</h3>
        <p>
          Products are typically delivered via download link or access
          instructions immediately after successful payment, or shortly
          thereafter.
        </p>
        <h3>3.3 Your Responsibility</h3>
        <p>
          You are responsible for ensuring your email address is correct and
          that your device/ software can open the files. We are not responsible
          for issues caused by unsupported software, outdated versions, or user
          error.
        </p>

        <h2 id="product-info">4. Product Information &amp; Availability</h2>
        <p>
          We aim to display products accurately. However, previews are
          illustrative and may vary by device, software, or AI model behaviour
          (where relevant). We do not guarantee that product descriptions,
          previews, or any site content are error-free.
        </p>

        <h2 id="changes">5. Modifications to Products &amp; Prices</h2>
        <p>
          Prices and product contents may change at any time. We may modify or
          discontinue products without notice. Where required by law, changes
          will not affect orders already completed.
        </p>

        <h2 id="licensing">6. Licensing Terms</h2>
        <p>
          These licensing terms explain what you may and may not do with what
          you purchase.
        </p>
        ...
        <ul>
          <li>
            <strong>Digital Products</strong>: any digital item sold on the
            site, including prompts, prompt packs, digital prints, mockups,
            blueprints, templates, design assets, files, guides, or downloads.
          </li>
          <li>
            <strong>Licensed Content</strong>: the Digital Products you purchase
            (including any included files, text, layouts, and documentation).
          </li>
          <li>
            <strong>End Product</strong>: a finished outcome you create using
            the Licensed Content (e.g., brand design, marketing creative, social
            post, video, website mock, rendered image, client presentation, or
            generated AI output).
          </li>
        </ul>
        ...
        <p>
          Subject to your compliance with these Terms and full payment,
          Raylodies grants you a limited, non-exclusive, non-transferable,
          non-sublicensable licence to access and use the Licensed Content in
          accordance with these Terms.
        </p>
        <p>
          Unless your product page states otherwise, your purchase includes a
          Standard Licence (Sections 6.3–6.11).
        </p>
        ...
        <ul>
          ...
          <li>
            Modify or adapt Licensed Content to create End Products, as long as
            you do not distribute the Licensed Content itself as a standalone
            file.
          </li>
          <li>
            Use Licensed Content in client work, provided the client receives
            only the End Product (exported visuals, flattened files, rendered
        ...
        <p>
          <strong>AI Output Note:</strong> AI-generated outputs can vary
          depending on model updates, settings, seed, and platform rules. We do
        ...
        <ul>
          <li>
            Download and use digital prints for personal display and personal
            printing.
          </li>
          <li>
        ...
        <ul>
          <li>
            Sell, license, or distribute the digital print as a standalone
            artwork file.
          </li>
          <li>
            Sell the print on merchandise, print-on-demand, marketplaces, or
            physical print sales as the main product (unless you have an
            Extended/Resale Licence if offered).
          </li>
        </ul>

        <h3>6.6 Mockups, Templates &amp; Assets — Special Rules</h3>
        <p>
          You may use mockups/templates/assets to present or market your work or
          your client’s work, but you may not:
        </p>
        <ul>
          <li>
            Resell or redistribute mockups/templates/assets as standalone items
            (original or modified), including packs/bundles/libraries.
          </li>
          <li>
            Give away source files to clients, teams, or third parties unless
        ...
        <p>
          Blueprints or guides may be creative, conceptual, or educational. They
          are not professional engineering, architectural, medical, or legal
          advice. You are responsible for ensuring compliance with safety
          standards, regulations, and real-world suitability before using any
          blueprint in practical implementation.
        </p>
        ...
        <ul>
          ...
          <li>
            Claim ownership of the Licensed Content itself, register it as a
            trademark/copyright, or misrepresent authorship.
          </li>
          <li>
            Use the Licensed Content in unlawful, infringing, or misleading
            ways.
          </li>
        </ul>
        ...
        <p>
          Unless the product page states otherwise, purchases are for
          single-user use. If a team/studio/organisation will access the files,
          you must purchase a multi-seat option (if available) or obtain written
          permission.
        </p>

        <h3>6.10 AI / Model Training Restriction</h3>
        <p>
          Unless explicitly permitted in writing by Raylodies, you may not use
          the Licensed Content to train, fine-tune, or improve any AI/ML model
          or to build datasets for training (including scraping, dataset
          packaging, or bulk ingestion).
        </p>

        <h3>6.11 Ownership &amp; Reservation of Rights</h3>
        <p>
          Raylodies (and/or its licensors) retains all rights, title, and
          interest in the Licensed Content. You receive a licence to use it —
          not ownership.
        </p>

        <h3>6.12 Product-Specific Terms</h3>
        <p>
          If a product page or included file specifies additional licence terms,
          those terms apply to that product. If there is a conflict, the
        ...
        <p>
          ...
          or goodwill arising from your use of the Service or Digital Products.
        </p>
        <p>
          Where liability cannot be excluded, it is limited to the amount you
          paid for the specific product giving rise to the claim (or the minimum
